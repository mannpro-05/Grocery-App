...
public class AddAdminActivity extends BaseActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        email = findViewById(R.id.register_admin_email);
        name = findViewById(R.id.register_admin_name);
        pass = findViewById(R.id.register_admin_password);
        repass = findViewById(R.id.register_admin_repassword);
        add = findViewById(R.id.register_admin_address);
        mobile = findViewById(R.id.register_admin_phone);
        register = findViewById(R.id.register_admin_button);
                        ...
                        if (task.isSuccessful()){
                            ...
                            FirebaseDatabase.getInstance().getReference("Users")
                                ...
                                public void onComplete(@NonNull Task<Void> task) {
                                    if (task.isSuccessful()) {
                                        Intent intent = new Intent(AddAdminActivity.this, DashboardActivity.class);
                                        startActivity(intent);
                                        loadingBar.dismiss();
                                        Toast.makeText(AddAdminActivity.this, "Success", Toast.LENGTH_LONG).show();
                                    } else {
                                        //display a failure message
                                        Intent intent = new Intent(AddAdminActivity.this, DashboardActivity.class);
                                        startActivity(intent);
                                        loadingBar.dismiss();
                                        Toast.makeText(AddAdminActivity.this, "Fail", Toast.LENGTH_LONG).show();
                                    }
                                }
                            });
                        }
